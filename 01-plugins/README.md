...
| 마켓플레이스 | GitHub 레포 | 상태 |
|---|---|---|
| claude-plugins-official | `anthropics/claude-plugins-official` | 활성 |
| claude-code-plugins | `anthropics/claude-code` | 활성 |
| bkit-marketplace | `popup-studio-ai/bkit-claude-code` | 활성 |
| hyperframes | `heygen-com/hyperframes` | 활성 |
| gptaku-plugins ★ | `fivetaku/gptaku_plugins` | 활성 |
| pixelrag-plugins | `StarTrail-org/PixelRAG` | 활성 |
| ~~omc~~ | `Yeachan-Heo/oh-my-claudecode` | 격리 2026-08-05 |
| ~~harness-marketplace~~ | `revfactory/harness` | 격리 2026-08-05 |
| ~~openai-codex~~ | `openai/codex-plugin-cc` | 격리 2026-08-05 |

## 설치되는 플러그인 (21 활성 / 6 격리)
