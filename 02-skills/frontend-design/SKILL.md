...
## AI Design Tool Control Loop

When using Claude Design/Open Design-style generators, do not jump straight from prompt to implementation. First lock a **brief gate** and make the model answer or infer:

- Platform/responsiveness target
- Audience and job-to-be-done
- Distance from any reference brand/style (e.g. “same warmth, clearly original”)
- Memorable visual motif, not just a palette
