---
name: conversion-ops
description: AI-powered conversion rate optimization, landing page audits, lead magnet strategy, and quote scoping for conversion-focused service websites.
tags:
  - cro
  - landing-pages
  - website-estimates
...
AI-powered conversion rate optimization: landing page audits, CRO scoring, survey segmentation, lead magnet generation, and service-website quote scoping.
...
- User receives a website-production inquiry where the prospect says “make a site like this URL” and asks for a quote
- User needs a client-ready proposal that separates landing-page, marketing-site, application-flow, and platform/back-office scope
...
### Website Inquiry Quote Scoping

When asked to answer a prospect who wants a site like a reference URL:

1. Verify the reference in a real browser instead of estimating from memory.
2. Inventory public page types, gated flows, CTA destinations, analytics tags, SEO assets, and content/CMS patterns.
3. Separate four scope levels:
   - MVP landing
   - marketing website with content lists/details
   - application/consultation system
   - full platform/back-office
4. Give a recommended price band and exclusions, not just a raw number.
5. Use the reference workflow file for a detailed checklist and Korean service-business quote tiers.
